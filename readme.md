...
<p><a href="https://github.com/Serilum/Quick-Right-Click"><img src="https://workflow.serilum.com/web/logo/128/quick-right-click.gif" width="100" height="100"></a></p><h2>Download</h2>
...
<p><span style="font-size:14px"><strong>enableQuickBeds</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking beds in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickCartographyTables</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking cartography tables in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickCraftingTables</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking crafting tables in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickEnderChests</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking ender chests in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickGrindstones</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking grindstones in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickShulkerBoxes</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking shulker boxes in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickSmithingTables</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking smithing tables in the air should enable the quick feature.</span><br><br><span style="font-size:14px"><strong>enableQuickStonecutters</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default true</span><br><span style="font-size:13px">If right-clicking stonecutters in the air should enable the quick feature.</span></p>
</div>
<h2><br><br><br><img src="https://cdn.serilum.com/description/nameplate/showcase.svg" alt="Showcase" width="838" height="64"></h2>
<p><span style="font-size:14px">Quickly sleep in a bed. It'll be placed down and picked up automatically once done sleeping.</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/quick-right-click/a.webp" alt=""></picture></p>
</details>
<p>&nbsp;</p>
<p><br><span style="font-size:14px">Quickly access your ender chest, without the need for silk touch to pick it back up.</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/quick-right-click/b.webp" alt=""></picture></p>
</details>
<p>&nbsp;</p>
<p><br><span style="font-size:14px">Open Shulker Boxes quickly, access its contents and be on your way.</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/quick-right-click/c.webp" alt=""></picture></p>
</details>
<p>&nbsp;</p>
<p><br><span style="font-size:14px">Craft items quickly without leaving crafting tables everywhere you go.</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/quick-right-click/d.webp" alt=""></picture></p>
</details>
<p>&nbsp;</p>
<p><br><span style="font-size:14px">Also works for cartography tables, and the other village profession blocks.</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/quick-right-click/e.webp" alt=""></picture></p>
</details>
